...
;;  (message "1: %s" (car project-buffer-master-project))
;;  (message "2: %s" (project-buffer-node->filename (ewoc-data (cdr project-buffer-master-project))))
;;  (message "platform: %s" project-buffer-current-platform)
;;  (message "config: %s" project-buffer-current-build-configuration)
