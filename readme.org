...
test2
This project store my emacs config.

* feature
  - support emacs25+
  - support windows & linux 
  - personal UI style
  - some personal shortcut keys
  - enable 'ido-mode' by default for command, open files, buffers
  - use 'ibuffer' to manager buffers
  - auto recognize utf8 and gbk coding by 'unicad'
  - 'browse-kill-ring'可查看所有剪切下来的文本
  - enhance 'dired', eg. dired-du-mode, dired-sort
  - feature 'unique' 
  - some C/C++ feature
  - support svn version control by psvn
  - support git version control by magit(v3.3.0)
  - support xcscope for view C/C++ code
  - support sr-speedbar(20210922)
  - multi-shell
  - "C-c o" open recent opened files fixed with ido
  - other feature
